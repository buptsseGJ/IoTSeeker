...
# 转移指令
IoTSeeker_allTransferInstr = ['reg', 'ops', 'bound', 'bound reg', 'int', 'into', 'iret', 'iretd', 'iretf', ]
# 堆栈指令
IoTSeeker_stackInstr = ['push', 'pop', 'pusha', 'popa', 'pushad', 'popad', 'pushf', 'popf', 'popal', 'pushd', 'popd',
                        'stmfa', 'ldmfa', 'stmed', 'ldmed', 'stmea', 'ldmea', 'stm', 'ldm', 'ldp', 'stp', 'stmfd',
                        'ldmfd', 'fucompp', 'fucomp', 'fucompi', 'fucomi']
# 算数指令
IoTSeeker_arithmeticInstr = ['xadd', 'aaa', 'aad', 'aam', 'aas', 'adc', 'add', 'addu', 'addiu', 'daa', 'dadd', 'adds',
...
# 逻辑指令
IoTSeeker_logicInstr = ['and', 'ands', 'andi', 'andeq', 'or', 'xor', 'not', 'eor', 'orr', 'teq', 'ori', 'nor', 'shl',
                        ...
                        'srlv']
# 逻辑指令
IoTSeeker_segInstr = ['bfc', 'bfi', 'bfxil', 'sbfiz', 'sbfx', 'ubfiz', 'bfm', 'sbfm', 'ubfm']
# 比较指令
IoTSeeker_compareInstr = ['test', 'tst', 'cmpxchg', 'cmp', 'cmn', 'fcmp', 'fcmpz', 'fcmpez', 'fcmpe', 'ccmp', 'cmpeq',
                          'ucomisd', 'comisd', 'csel', 'cset', 'csetm', 'cinc', 'cinv', 'csinc', 'csinv', 'slt', 'slti',
                          'sltu', 'sltui', 'sltiu', 'cmpsb', 'ucomiss']
# 调用
IoTSeeker_externalInstr = ['blx', 'bx', 'call', 'callq', 'bl', 'bal']
IoTSeeker_internalInstr = []
# 条件跳转
IoTSeeker_conditionJumpInstr = ['jle', 'loop', 'loopw', 'loopd', 'loope', 'loope', 'loopz', 'loopne', 'loopnz', 'jcxz',
                                ...
                                'jecxz']
# 非条件跳转
IoTSeeker_unconditionJumpInstr = ['jmp', 'ret', 'retn', 'b', 'br', 'blr', 'j', 'jr', 'eret', 'bal', 'leave']
# 基本指令
IoTSeeker_genericInstr = ['mov', 'move', 'movz', 'movn', 'movne', 'movk', 'fmov', 'mvn', 'movsx', 'movzx', 'movsd',
