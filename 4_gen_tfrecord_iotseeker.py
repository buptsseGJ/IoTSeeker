...
TRAIN_TFRECORD = config.TFRECORD_IOTSEEKER_DIR_DIR + os.sep + "train_"+PREFIX+".tfrecord"
TEST_TFRECORD = config.TFRECORD_IOTSEEKER_DIR_DIR + os.sep + "test_"+PREFIX+".tfrecord"
VALID_TFRECORD = config.TFRECORD_IOTSEEKER_DIR_DIR + os.sep + "valid_"+PREFIX+".tfrecord"
