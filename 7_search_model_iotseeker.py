...
with tf.Session() as sess:
    saver.restore(sess, config.MODEL_IOTSEEKER_DIR+os.sep+config.STEP7_SEARCH_IOTSEEKER_MODEL)
    ...
    if not os.path.exists(config.SEARCH_RESULT_IOTSEEKER_DIR + os.sep + cve_dir):
        os.mkdir(config.SEARCH_RESULT_IOTSEEKER_DIR + os.sep + cve_dir)
    result_file = config.SEARCH_RESULT_IOTSEEKER_DIR + os.sep + cve_dir + os.sep + str(search_program) + ".csv"
